    ...
    private async seedUpgrades() {
        ...
        if (count == 0) {
            const data = [
                ...
                { id: 12, name: 'GP Lunaire', price: 10, price_unit: Unit.UNDECILLION, ratio: 1, generationUpgradeId: 11, value: 0.1, imagePath: 'test.png' },
                { id: 13, name: 'Générateur Oxygène', price: 10, price_unit: Unit.DUODECILLION, ratio: 1, generationUpgradeId: 12, value: 0.1, imagePath: 'test.png' },
                { id: 14, name: 'GP Marsien', price: 10, price_unit: Unit.TREDECILLION, ratio: 1, generationUpgradeId: 13, value: 0.1, imagePath: 'test.png' },
                { id: 15, name: 'Bouclier Thermique', price: 10, price_unit: Unit.QUATTUORDECILLION, ratio: 1, generationUpgradeId: 14, value: 0.1, imagePath: 'test.png' },
                { id: 16, name: 'GP Solaire', price: 10, price_unit: Unit.QUINDECILLION, ratio: 1, generationUpgradeId: 15, value: 0.1, imagePath: 'test.png' },
                { id: 17, name: 'Générateur de Distortions', price: 10, price_unit: Unit.SEXDECILLION, ratio: 1, generationUpgradeId: 16, value: 0.1, imagePath: 'test.png' },
                { id: 18, name: 'GP Trou Noir', price: 10, price_unit: Unit.OCTODECILLION, ratio: 1, generationUpgradeId: 17, value: 0.1, imagePath: 'test.png' },
                { id: 19, name: 'Moteur Subliminique', price: 10, price_unit: Unit.NOVEMDECILLION, ratio: 1, generationUpgradeId: 18, value: 0.1, imagePath: 'test.png' },
                { id: 20, name: 'GP Voie Lactée', price: 10, price_unit: Unit.VIGINTILLION, ratio: 1, generationUpgradeId: 19, value: 0.1, imagePath: 'test.png' },
                { id: 21, name: 'Moteur Hyperspatial', price: 10, price_unit: Unit.UNVIGINTILLION, ratio: 1, generationUpgradeId: 20, value: 0.1, imagePath: 'test.png' },
                { id: 22, name: 'GP Galactique', price: 10, price_unit: Unit.DUOVIGINTILLION, ratio: 1, generationUpgradeId: 21, value: 0.1, imagePath: 'test.png' },
                { id: 23, name: 'Téléporteur', price: 10, price_unit: Unit.TRESVIGINTILLION, ratio: 1, generationUpgradeId: 22, value: 0.1, imagePath: 'test.png' },
                { id: 24, name: 'GP Universel', price: 10, price_unit: Unit.QUATTUORVIGINTILLION, ratio: 1, generationUpgradeId: 23, value: 0.1, imagePath: 'test.png' },
                { id: 25, name: 'Distrotion Spatiale', price: 10, price_unit: Unit.QUINQUAVIGINTILLION, ratio: 1, generationUpgradeId: 24, value: 0.1, imagePath: 'test.png' },
